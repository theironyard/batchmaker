window.DashboardView = Backbone.View.extend({
  ...
  render: ->
    ...
    recipes.each (recipe, index) ->
      $('section.my-recipes-row').append JST['backbone/templates/recipes/grid-item'](recipe)
    
    publicCollection.each (recipe, index) ->
      $('section.public-recipes-row').append JST['backbone/templates/recipes/grid-item'](recipe)
    
    popularCollection.each (recipe, index) ->
      $('section.popular-recipes-row').append JST['backbone/templates/recipes/grid-item'](recipe)
    
    favoriteCollection.each (recipe, index) ->
      $('section.favorite-recipes-row').append JST['backbone/templates/recipes/grid-item'](recipe)
